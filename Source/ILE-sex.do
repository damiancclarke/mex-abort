...
log using "ILE-sex.txt", text replace
...
set seed 82130
local Nreps 150
rename est_ContraKnow        _v1
rename est_mod_contrcep      _v2
rename est_any_contra_method _v3
rename est_age_marriage      _v4
rename est_age_first_sex     _v5
rename est_num_sex_partners  _v6
...
\caption{The Effect of the Abortion Reform on Reported Sexual Behaviour`lc'}
...
\bottomrule
\multicolumn{8}{p{16cm}}{\begin{footnotesize} Each column presents a seperate
