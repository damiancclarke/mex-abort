...
********************************************************************************
*** (4) Graph only keeping +3 years
********************************************************************************
gen difyear=syear-ano_nac
keep if difyear<=3
drop syear
reshape wide birth, i(ano_nac) j(difyear)
graph bar birth0 birth1 birth2 birth3, over(ano_nac) stack scheme(s1color) /*
*/ ytitle("100,000s of Births") /*
*/ legend(lab(1 "Year of survey")  lab(2 "+1 year") lab(3 "+2 years") /*
*/ lab(4 "+3 years"))
graph export "$OUT/BirthsPerYear_3year.eps", as(eps) replace
