...
\input{tables/SumStatCharacteristics.tex}
\begin{tablenotes}
...
\begin{threeparttable}
 {\footnotesize  \input{tables/MainBirth.tex}}
\begin{tablenotes}
\footnotesize
...
\begin{threeparttable}
{\footnotesize\input{tables/MainMMR.tex}}
\begin{tablenotes}
\footnotesize
...
{\footnotesize  \input{tables/MainBirth_Hetro_R.tex}}
\end{subtable}
\begin{subtable}{1\textwidth}  \subcaption{Maternal Mortality}\label{heteroReg:1b}
{\footnotesize  \input{tables/MainMMR_Hetro_R.tex}}
\end{subtable}
\begin{tablenotes} 
\footnotesize
...
{\footnotesize \input{tables/MainBirth_ContraceptionMxFLS_R.tex}}
\end{subtable}
\begin{subtable}{\textwidth}\centering\subcaption{Maternal Mortality}\label{meckMMR}
{\footnotesize  \input{tables/MainMMR_ContraceptionMxFLS_R.tex}}
\end{subtable}
\begin{tablenotes}
\footnotesize
